...
class PreparacionModel(base_de_datos.Model):
    ...
    preparacionId = Column(name='id', type_=types.Integer, unique=True,
    ...
    # DELETE  => Se elimnara y dejara a las FK con el mismo valor generando informacion incorrecta
    # RESTRICT => restringir la eliminacion siempre y cuando FK existentes
    # None => no hagas nada

    postre = Column(ForeignKey(column='postres.id', ondelete="CASCADE"), name='postre_id',
